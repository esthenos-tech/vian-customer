...
import { getAllProductsCategoryDetails } from "../components/dataLayer/OrganisationProducts/index";
import { TextField } from "../components/CommonComponents/TextField";

const CustomFilterWithAppName = ({ handlerSubmitFilterDate }) => {
  ...
  return (
    <Formik
      ...
      onSubmit={(values, { resetForm }) => {
        ...
        selectRef5.current.select.clearValue();
        resetForm();
      }}
    >
      {(formik) => {
                ...
                <Row>
                  ...
                  <Col className="mb-1" md="4" sm="12">
                    <Select
                      ...
                      onChange={(option) => {
                        if (option) {
                          setFieldValue("category_code", option.value);
                        } else {
                          setFieldValue("category_code", "");
                        }
                      }}
                      onBlur={handleBlur}
                      ref={selectRef5}
...
export default CustomFilterWithAppName;
